...
#               Build                  #
########################################
ARG RELAY_VERSION="v1.29.0-rc.2"
ARG DISCO_VERSION="v1.29.0-rc.2"
ARG RELAY_DOWNLOADURL="https://github.com/syncthing/relaysrv/releases/download/v1.29.0-rc.2/strelaysrv-linux-amd64-v1.29.0-rc.2.tar.gz"
ARG DISCO_DOWNLOADURL="https://github.com/syncthing/discosrv/releases/download/v1.29.0-rc.2/stdiscosrv-linux-amd64-v1.29.0-rc.2.tar.gz"
ARG BUILD_DATE="2024-12-27T15:09:17Z"
########################################
